...
description: |
  ...
  DayTrade 対応済み——村上文体、激しい感情の人間ドラマ、自然な時間交差、滲み出し層、劇的アイロニーを評価基準とする。
...
- **文体の一貫性**：語り手の声（誠＝理論派・数字で秩序を頼りにするが感情が溢れ出す／栞＝二重言語／翼＝身体感覚→内省）が章を通して維持されているか。
...
- 指示プロンプト：
  ...
  DayTradeの場合の追加チェック項目：
  1. 語り手の声はキャラクターの言語スタイル定義と一致しているか？（誠＝理論派・数字で秩序を頼りにするが感情が溢れ出す／栞＝二重言語／翼＝身体感覚→内省）
...
- 指示プロンプト：
  ...
  DayTradeの場合の追加チェック項目：
  1. 内省は具体的な過程として書かれているか？空虚な一語要約（「悲しかった」）がないか？感情は行動と身体反応、内省の過程で描かれているか？
