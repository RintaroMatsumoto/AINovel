...
3. **情報を分割開示する**：封筒8通それぞれで異なる層の真実を明かす。1通で全てを語らない。読者は誠と同時に真実を知り、誠と一緒に誤解する。多崎つくるの巡礼構造を参照
4. **封筒のリズムで文体を変化させる**：毎月1通・8ヶ月。封筒が過激化するにつれて誠の抑制された内省が綻び、句読点の乱れと短い断片へ——文体そのものが崩壊を描く
...
| 巻 | 主人公 | 内容 | 文体参照 |
|----|--------|------|---------|
| GoldenCross | 橘誠（40歳） | 一人称悲劇。封筒で精神崩壊→問い詰め→心中。内省駆動 | 村上春樹（国境の南、多崎つくる、ノルウェイの森） |
...
3. 情報開示のタイミングを決める——読者は誠と同時に知る（参照：`references/dramatic-irony.md`）
4. 各章の計画書を作成する
