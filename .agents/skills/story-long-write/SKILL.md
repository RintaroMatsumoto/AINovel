...
3. **情報を分割開示する**：封筒6通＋百合子視点の章で異なる層の真実を明かす。読者は百合子視点で誠より先に真実を知り、誠視点で誠の誤解を追体験する——二層の劇的アイロニー。
4. **封筒のリズムで文体を変化させる**：月1通・全6通。11月のみ空白月。封筒が過激化するにつれて、数字で秩序を頼りにしていた誠の内省が綻び、語りは断片化し、最終的には沈黙に至る——文体そのものが崩壊を描く
...
- 文体方針：激しい感情の人間ドラマ・自然な時間交差・一人称・横書き（村上春樹基調）
- 3人の声の確認：誠（理論派。数字で秩序を頼りにするが、封筒により根底の感情が表面化し、語りが断片化→沈黙へ）、栞（二重言語＋身体感覚）、翼（各フェーズで声が変わる→弱さの受容）
- 3巻の基本構造を確認
