"""
橘百合子 18歳 ショートver: 私服×5, 会社×5
Usage: py novels/生成/gen_yuriko_short.py
"""
...
NEG = ("EasyNegative, (worst quality:1.2), (low quality:2), (normal quality:2), "
       ...
       "makeup, frills, lace, ribbon, glitter, high heels, long nails, "
       "earrings, necklace, accessories, curly hair, perm, wavy")
...
PROMPTS = {
    "yuriko_office_short": (
        ...
        "medium short black hair at chin length, neat simple hairstyle, "
        "naive rustic face, no makeup, fresh-faced, shy first job, "
        "cheap but clean navy office jacket, plain white button-up blouse, "
        "knee length straight skirt, plain low heel pumps, "
        "office corridor, provincial girl out of place in city, "
        "looking down slightly, clutching notepad nervously, t_yuriko_f"
    ),
    "yuriko_casual_short": (
        "私服",
        "(masterpiece, best quality:1.2), 8k, RAW photo, (Realistic, hyper realistic, photorealistic:1.3), ultra detailed, "
        "18 year old japanese young woman, petite small frame, short stature, "
        "medium short black hair at chin length, simple natural hairstyle, "
        "naive rustic face, no makeup, fresh-faced, shy blush, "
        "cheap but clean old sweater, plain worn skirt, old scuffed sneakers, "
        "urban street, provincial country girl in big city, t_yuriko_f"
    ),
}
...
if __name__ == "__main__":
    office_seeds = [3501, 3533, 3565, 3597, 3629]
    casual_seeds = [3661, 3693, 3725, 3757, 3789]
