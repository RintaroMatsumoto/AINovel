"""叔母: Dual IPAdapter v2 - ワンピース・膝下丈"""
...
NEG = ("(worst quality:1.4), (low quality:1.4), EasyNegative, badhandv4, "
       ...
       "miniskirt, short skirt, mini skirt, above knee, skirt above knee, short hem, "
...
PROMPT = ("(masterpiece, best quality:1.2), 8k, (Realistic, photorealistic:1.3), ultra detailed, "
          "japanese elderly woman, 65, aunt, plump chubby fuller figure, "
          "gray white hair, natural makeup, "
          "wearing (all black:1.3) one-piece mourning dress, "
          "high neck, long sleeves, "
          "long hem below knees, dress hem reaches below knee, "
          "single strand pearl necklace, "
          "portrait, neutral background, dignified tired expression")
...
for i in range(5):
    ...
    prefix = f"oba_dual2_fid_s{seed}_{i+1:02d}"
