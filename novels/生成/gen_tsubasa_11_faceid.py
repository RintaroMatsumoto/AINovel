...
SCENES = [
    "school uniform, white shirt, navy shorts, standing in classroom, front view, smiling at camera",
    "school uniform, walking in school hallway, three-quarter view, looking ahead, school bag",
    "casual clothes, graphic t-shirt, jeans, playing at park, laughing, afternoon sunlight",
    "home clothes, sitting on floor, playing with toy car, concentrated happy face",
    "school uniform, at school entrance, backpack, waving goodbye, smiling",
    "casual, hoodie, sitting on sofa, watching TV, relaxed expression, living room",
    "school uniform, sitting at classroom desk, writing, profile view, concentrated",
    "casual, striped t-shirt, riding bicycle, summer, wind in hair, laughing",
    "home, pajamas, sitting on bed, reading comic, morning light through window",
    "portrait close-up, white shirt, front view, big eyes, curious innocent expression",
]
...
for i, scene in enumerate(SCENES, 1):
    ...
    prompt = (f"(masterpiece, best quality:1.2), 8k, RAW photo, "
              ...
              f"short black hair, small thin build, cute boyish face, "
              f"{scene}")
    prefix = f"tsubasa_11_fid08_s{seed}_{i:02d}"
