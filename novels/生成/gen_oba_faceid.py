...
SCENES = [
    "1woman, 65 year old japanese woman, aunt, gray streaked hair, natural mature face, wearing formal black mourning dress, simple black blazer, portrait, neutral background, soft natural light, front view, looking at camera",
    "1woman, 65 year old japanese lady, aunt, salt and pepper hair, mature face, formal black dress, black jacket, plain background, composed expression, three-quarter view",
    "1woman, 65 year old japanese woman portrait, gray hair neat style, natural mature beauty, wearing black mourning attire, dignified expression, soft lighting, head and shoulders",
    "1woman, 65 year old japanese aunt, gray hair pulled back, graceful aging, wearing formal black dress, gentle tired eyes, composed expression, half body portrait, natural light",
    "1woman, 65 year old japanese woman, salt and pepper hair, natural aged skin, wearing black mourning outfit, quiet dignified look, front portrait, soft window light",
]
...
for i, scene in enumerate(SCENES, 1):
    ...
    prompt = (f"(masterpiece, best quality:1.2), 8k, RAW photo, "
              ...
              f"{scene}")
    prefix = f"oba_faceid_cfg{CFG}_s{seed}_{i:02d}"
