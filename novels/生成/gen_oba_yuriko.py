...
NEG = ("(worst quality:1.4), (low quality:1.4), EasyNegative, badhandv4, "
       ...
       "makeup, lipstick, blush, stylish, model, "
       "young, beautiful, pretty, cute, "
       "v-neck, low neck, plunging, sleeveless, bare arms, bare shoulders, bare skin, "
       "open collar, deep neckline, cleavage, décolletage, "
       ...
       "pink, purple, pastel, bright, light color, "
       "fashionable, trendy, modern, elegant, chic, "
       "kimono, wafuku, japanese traditional")

SCENES = [
    "japanese elderly woman, 65, aunt, wearing all black funeral dress, black blazer, high neck, long sleeves, covered fully, portrait, neutral background, dignified tired expression",
    "japanese elderly woman, 65, aunt, all black mourning outfit, closed neck, long sleeves, black formal dress, plain background, quiet composed look",
    "japanese elderly woman, 65, aunt, black funeral attire, high closed collar, long sleeves to wrists, all black, portrait, neutral bg, natural light",
    "japanese elderly woman, 65, aunt, simple black funeral dress, black cardigan, high neck, long sleeves, no skin visible, plain background, tired gentle eyes",
    "japanese elderly woman, 65, aunt, formal black mourning clothes, covered neck and arms, all black, proper funeral wear, portrait, neutral background",
]

print("Uploading ref (百合子方式)...")
with open(REF, "rb") as f:
    r = requests.post(f"{BASE}/upload/image", files={"image": ("oba_yuriko_ref.png", f, "image/png")}, timeout=30)
...
for i, scene in enumerate(SCENES, 1):
    ...
    prompt = (f"(masterpiece, best quality:1.2), 8k, (Realistic, photorealistic:1.3), ultra detailed, "
              f"({scene})")
    prefix = f"oba_yuriko_fid_s{seed}_{i:02d}"
