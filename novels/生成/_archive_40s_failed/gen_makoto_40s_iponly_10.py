"""誠40歳退職前: Regular IPAdapterのみ (FaceID不使用) 10枚
参照: cafe_street s6250727949 — 顔も髪もメガネもこの画像が完成形
手法: IPAdapter STANDARD + "prompt is more important"
"""
...
def gen_one(seed, prompt, neg, ref_name, prefix):
    ...
    wf = {
        ...
        "4": {"class_type": "IPAdapter", "inputs": {"model":["2",0], "ipadapter":["2",1], "image":["3",0], "weight":IPW, "start_at":0.0, "end_at":1.0, "weight_type":"prompt is more important"}},
...
print("誠40歳: IPAdapterのみ 10枚（FaceID不使用）...")
ref_name = upload_ref()
if not ref_name:
    print("ABORT"); exit(1)
