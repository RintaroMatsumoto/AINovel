...
# Subtle gray — just a touch at temples, natural
HAIR = ("short neatly combed hair, natural side part, "
        "slight gray at temples, a few silver strands, "
        "subtle graying, natural mature hair, well-groomed")

GLASSES = "(silver thin metal frame glasses:1.2)"

VARIANTS = [
    ("front_navy", "navy suit, white shirt, dark red tie, front view, standing, calm"),
    ("front_grey", "charcoal suit, white shirt, navy tie, front view, standing, professional"),
    ("front_coat", "navy overcoat, suit, red tie, front view, outdoor"),
    ("desk_docs", "white shirt, navy vest, sitting at desk, reading papers, focused"),
    ("desk_computer", "white shirt, tie loosened, at computer, concentrated"),
    ("desk_phone", "navy jacket, sitting at desk, phone to ear"),
    ("desk_late", "white shirt, tie undone, exhausted late night, dim"),
    ("meeting_sit", "navy suit, red tie, sitting at table, listening"),
    ("meeting_stand", "navy suit, burgundy tie, standing at whiteboard, presenting"),
    ("hallway_walk", "navy suit, red tie, walking with briefcase"),
    ("hallway_door", "grey suit, at door, hand on handle"),
    ("window_look", "navy suit, tie loosened, by window, thoughtful"),
    ("cafe_read", "white shirt, vest, at cafe reading paper, break"),
    ("commute_platform", "navy suit, overcoat, scarf, on platform"),
    ("commute_evening", "navy suit, loosened tie, walking on street, evening"),
]
