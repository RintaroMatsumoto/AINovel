"""翼14歳少年院: 丸坊主・あずき色ジャージ・白Tシャツ 5枚 FaceID"""
...
NEG = ("EasyNegative, (worst quality:1.2), (low quality:2), (normal quality:2), "
       ...
       "hair, any hair on head, stubble, beard")
...
SCENES = [
    "standing in juvenile detention cell, full body, front view, looking at camera, institutional concrete walls, fluorescent light, cold atmosphere",
    "sitting on edge of prison bed, hands on knees, looking down, empty defeated expression, small cell, gray concrete",
    "standing in detention hallway, three-quarter view, rigid posture, fists clenched, looking ahead with hard eyes",
    "close-up portrait, shaved head clearly visible, no hair at all, cold dead eyes, neutral expression, gray background",
    "sitting in corner of cell on floor, back against wall, knees up, arms resting on knees, looking away, trapped",
]
...
for i, scene in enumerate(SCENES, 1):
    ...
    prompt = (f"(masterpiece, best quality:1.2), 8k, RAW photo, "
              ...
              f"14 year old japanese boy, completely shaved head, no hair, bald head, "
              f"thin malnourished build, juvenile detention inmate, "
              f"wearing white t-shirt underneath, azuki-red japanese prison tracksuit jacket unzipped, azuki-red tracksuit pants, "
              f"angry resentful eyes, defensive hardened expression, "
              f"{scene}")
    prefix = f"tsubasa_14_juv_fid075_s{seed}_{i:02d}"
