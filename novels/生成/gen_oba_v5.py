...
SCENES = [
    "japanese elderly woman, 65 years old, gray hair pulled back, plain natural face no makeup, wearing simple black funeral dress, black cardigan, ordinary older lady, tired expression, plain background",
    "japanese old woman, 65, gray streaked hair, no makeup natural face, simple black dress black jacket, normal elderly lady, funeral clothes, composed, neutral background",
    "japanese elderly female, 65, gray white hair, natural aged skin no makeup, ordinary black mourning outfit, black blouse black skirt, plain normal older woman, tired eyes",
    "japanese old lady, 65, gray hair in bun, face wrinkles normal aging no makeup, simple black one-piece, black cover, regular grandmother age, quiet expression, plain bg",
    "japanese elderly woman portrait, 65, gray salt pepper hair, natural old face no makeup, plain black funeral dress, cardigan, ordinary older japanese woman, no style simple",
]
...
for i, scene in enumerate(SCENES, 1):
    ...
    prompt = f"(masterpiece, best quality:1.2), 8k, (Realistic, photorealistic:1.3), ultra detailed, {scene}"
    prefix = f"oba_v5_fid_s{seed}_{i:02d}"
    ...
    try:
        ...
        print(f"  [{i}/5] SUBMIT FAIL"); continue
