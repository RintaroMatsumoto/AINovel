"""翼14歳少年院: 3mm坊主・あずき色ジャージ上下 5枚 FaceID"""
...
NEG = ("EasyNegative, (worst quality:1.2), (low quality:2), (normal quality:2), "
       ...
       "completely bald, shaved head, no hair, skinhead, "
       "beard, stubble, facial hair, mustache")
...
SCENES = [
    "front view, standing in detention cell, looking at camera, hard eyes, thin build, institutional concrete walls, fluorescent light",
    "sitting on edge of prison bed, hands clasped, looking down, closed-off expression, small cell, cold atmosphere",
    "three-quarter view, standing in detention hallway, rigid posture, fists at sides, looking ahead with angry eyes",
    "close-up portrait, very short buzz cut 3mm, visible black stubble on scalp, cold eyes, neutral expression, gray background",
    "sitting on floor in corner of cell, back against wall, knees up, arms resting on knees, looking away, trapped, dim light",
]
...
for i, scene in enumerate(SCENES, 1):
    ...
    prompt = (f"(masterpiece, best quality:1.2), 8k, RAW photo, "
              ...
              f"very short buzz cut hairstyle, 3mm hair length, close cropped hair, black stubble scalp, "
              f"thin young build, still growing, "
              f"wearing white t-shirt, azuki-red japanese prison tracksuit, azuki-red tracksuit jacket, azuki-red tracksuit pants, "
              f"defensive hardened expression, angry resentful eyes, "
              f"{scene}")
    prefix = f"tsubasa_14_juv_v2_fid075_s{seed}_{i:02d}"
