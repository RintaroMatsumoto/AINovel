...
SCENES = [
    "1woman, elderly japanese woman, 65 years old, aunt, gray streaked hair tied back, simple comfortable cardigan and skirt, standing in traditional japanese living room, holding old box, serious gentle expression, warm afternoon light, sapporo home",
    "1woman, 65 year old japanese aunt, gray hair in simple bun, plain sweater, wrinkled kind face, sitting at dining table, talking on phone, worried expression, modest japanese home, daylight",
    "1woman, elderly japanese woman, 60s, gray perm hair, wearing simple apron, standing in kitchen, preparing tea, traditional japanese house, warm kitchen light, calm daily life",
    "1woman, 65 year old japanese aunt, gray hair pulled back, glasses, cardigan over blouse, standing at entrance of traditional house, holding door, looking outside, gentle concerned eyes",
    "1woman, elderly japanese woman portrait, 60s, gray streaked hair, wrinkled gentle face, kind tired eyes, simple modest clothing, traditional japanese interior background, soft lighting",
]

print("Generating aunt images with majicMIX...")
for i, scene in enumerate(SCENES, 1):
    ...
    prompt = (f"(masterpiece, best quality:1.2), 8k, RAW photo, "
              ...
              f"(old:1.2), (elderly:1.2), "
              f"{scene}")
    prefix = f"oba_majic_cfg{CFG}_s{seed}_{i:02d}"
