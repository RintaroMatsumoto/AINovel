"""百合子34歳: 顔も髪も固定（Config#3準拠）で服装・表情・角度だけ変えて5枚"""
...
AGING_STRONG = ("worn exhausted mother of two, visible aging signs on face, tired worn expression, "
                "realistic older woman face, dark circles under eyes, crows feet around eyes, "
                "no makeup, dull natural skin, realistic mature woman, natural skin texture")

HAIR_BASE = "long straight black hair, hair reaches middle of back"
...
# 5 variants — different clothing, expression, angle, setting
VARIANTS = [
    ...
    ("livingroom_profile",
     ...
     "morning light filtering through curtains, quiet melancholy"),
    ("dining_side",
     "long hair, side part",
     "plain shirt, at dining table with coffee cup, "
     "side angle from 45 degrees, staring at coffee, "
     "midday, no one else around, still"),
    ("veranda_rain",
    ...
    ("bedroom_wardrobe",
     ...
     "old worn t-shirt, standing before open wardrobe in bedroom, "
    ...
    ("entrance_evening",
     ...
     "evening glow from outside, tired small smile"),
]
...
for i,(name,hair_d,clothes_pose) in enumerate(VARIANTS,1):
    ...
    prompt=f"{BASE_POS}, {hair_d}, {clothes_pose}, {AGING_STRONG}"
