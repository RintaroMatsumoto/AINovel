...
- 詳細は `novels/参考/販売戦略.md` `novels/設定/題材定位.md` を参照。
...
| 桐生和代 | 妻。18歳高卒入社→西村にレイプ→16年間支配される→自ら命を絶つ。34歳。 |
| 桐生栞 | 主人公②。長女。14歳で両親死亡→施設→立ちんぼ→トレード→西村殺害→リョウに殺害。18歳。 |
| 桐生翔 | 主人公③。長男。11歳で両親死亡→里親レイプ→少年院→格闘技→地下格→タイトルマッチ→半身不随→弁護士来訪→車椅子トレーダー→30歳で施設建設。 |
| 西村健吾 | 敵。誠一の同期。新入社員狙いの常習犯。和代を16年間支配。栞＋リョウに殺害。 |
| 加藤リョウ | 栞のケツモチ。西村殺害の共犯→栞を殺害。翔とリングで対峙。 |

### 三部作構成
| 巻 | タイトル | 主人公 | 内部構成 | 想定字数 |
|----|---------|--------|---------|---------|
| 1 | GoldenCross | 誠一 | 上昇トレンド→DeadCross→幕切れ（心中） | 約12万字 |
| 2 | DeadCross | 栞 | 迷子の移動平均線→カスタマー→共犯者→再びのDeadCross（栞死亡） | 約14万字 |
| 3 | Breakout | 翔 | カオス・ブレイク→ファイトマネー→Breakout→EP | 約16万字 |
| SP | LossCut | 和代 | 特別編：妻の視点から見た全三部の真実 | 約2万字 |
