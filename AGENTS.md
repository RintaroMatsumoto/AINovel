...
|----|---------|--------|---------|---------|
| 1 | ゴールデンクロス | 誠一 | 上昇トレンド→ロスカット→幕切れ（無理心中） | 約12万字 |
| 2 | ロスカット | 栞 | 施設→カスタマー→共犯者→再びのデッドクロス（栞死亡） | 約14万字 |
| 3 | ブレイクアウト | 翔 | カオス・ブレイク→ファイトマネー→ブレイクアウト→EP | 約16万字 |
| SP | デッドクロス | 和代 | 特別編：妻の視点から見た全三部の真実 | 約2万字 |
